...
loghandler = {
    notparam: {
        ...
        getApikey: 'Contact shefinkl14 for API Key!'
    },
    notkey: {
        status: false,
        creator: `${creator}`,
    ...
    nottext2: {
        ...
        creator: `${creator}`,
        code: 406,
        message: 'Enter the text2'
    },
    nottext3: {
        status: false,
        creator: `${creator}`,
        code: 406,
        message: 'Enter the text3'
    },
    nottheme: {
        status: false,
        creator: `${creator}`,
    ...
    invalidKey: {
        ...
        creator: `${creator}`,
        code: 406,
        message: 'Invalid API key. Contact shefinkl14 for API Key'
    },
    invalidlink: {
        status: false,
        creator: `${creator}`,
...
router.get('/find', async (req, res, next) => {
    ...
    if (apikey != 'sh9567e48f94in04') return res.json(loghandler.invalidKey)
...
router.get('/tiktod', async (req, res, next) => {
	...
	if(!apikeyInput) return res.json(loghandler.notparam)
	if(apikeyInput != 'sh9567e48f94in04') return res.json(loghandler.invalidKey)
